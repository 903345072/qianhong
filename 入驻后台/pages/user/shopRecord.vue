...
<script>
	...
	import testBill from '@/components/zaiui-common/user/shopBill';
	...
	export default{
		...
		data(){
			return {
				...
				refresherStatus: 0,
				swiperHeight: 0,
				tabList: [ '系统', '跟单佣金','服务费','提现','充值'],
				types:["system","flow_yj","order_reduce","withdraw","recharge"],
			...
			// 	refresherStatus: 0,
			// 	swiperHeight: 0,
			// 	tabList: [ '加/扣款', '下单扣费','发单佣金(本)','发单佣金(他)','佣金扣费'],
			// 	types:["recharge","order_reduce","send_yj_self","send_yj_other","flow_yj_reduc"],
			// 	current: 0, // tabs组件的current值，表示当前活动的tab选项
			// }
		},
		methods:{
