<template>
	<view class="zaiui-home-box" :class="show?'show':''">
		...
		<view class="" >
			...
			<bar-title bgColor='bg-white' @rightTap="barEditTap" :isBack="true" style="z-index: 998;">
		              ...
		              <view class="item-title" style="padding: 30rpx 20rpx;background-color: white;margin-bottom: 20rpx;" @click="open(item)">
									<view style="display: flex;align-items: flex-start;justify-content: center;flex-direction: column;padding-bottom: 25rpx;line-height: 50rpx;">
										...
										<view style="font-size: 22rpx; color: #adadad;display: flex;align-items: center;justify-content: space-between;width: 100%;">
											...
											<view style="background-color: #d659ff;padding: 5rpx 30rpx;border-radius: 10rpx;color: white;display: none;" @click.stop="deleteOrder(item.id,index)">删除</view>
										</view>
									</view>
						...
						<uni-popup ref="popup" :mask-click="true" type="top"  style="z-index: 999;"  backgroundColor="#FAFAFA">
	...
	export default {
		...
		methods: {
			...
			uploadPhoto(tempFilePaths,id) { 
				uni.uploadFile({
					url: config.config.url+"common/index/uploadOrderPic?id="+id, //开发者服务器 url
					header:{
