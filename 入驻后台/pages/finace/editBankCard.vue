	...
	<view>
		...
		<view style="background-color: white;padding: 50rpx 20rpx;margin: 20rpx 20rpx;border-radius: 10rpx;">
			...
			<view style="margin: 30rpx 0;display: flex;color: grey;">
				<view style="margin: 0 20rpx;" >持卡人</view>
				<view>
					<input @input="input3" v-model="real_name" placeholder="请输入持卡人" />
				</view>
			</view>
			<view style="margin: 30rpx 0;display: flex;color: grey;">
...
<script>
	...
	export default{
		...
		methods:{
			submit(){
				if(!this.bank_card || !this.bank_name || !this.real_name){
					uni.showToast({
						title:"请输入完整信息",
						icon:"error"
					})
				...
				var data = {"bank_card":this.bank_card,"bank_name":this.bank_name,"real_name":this.real_name}
