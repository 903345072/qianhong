<template>
	<view class="zaiui-news-box" :class="show?'show':''">
		...
		<view style="background: linear-gradient(to right,#ffeef5,#f041ff);padding: 40rpx 60rpx;width: 90%;margin: 0 auto;border-radius: 5rpx 5rpx 20rpx 20rpx;">
			<view style="display: flex;align-items: center;">
				<view style="font-size: 30rpx;">店主获得彩民跟单佣金1.5%:</view>
				<view style="margin-left: 20rpx;font-size: 30rpx;color: red;">￥{{flow_amount}}</view>
			</view>
			...
			getData(){
				...
				this.$api.getTimeArea(data).then(res=>{
					...
					this.$api.tongji(data1).then(res=>{
						...
						that.flow_amount = res.data.flow_amount
						that.send_yj = res.data.send_yj
						that.send_yj_other = res.data.send_yj_other
						that.send_yj_self = res.data.send_yj_self
