<template>
	<view class="zaiui-news-box" :class="show?'show':''">
		...
		<view style="position: fixed;z-index: 9999;left: 0;right: 0;top:100rpx;background: red;height: 130rpx;display: flex;align-items: center;">
		...
		<meTabs v-model="TabCur" :tabs="tabList" :fixed="true" :tab-width="130" style="margin-top: 230rpx;;"></meTabs>
