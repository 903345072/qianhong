<template>
	<view>
		...
		<payorder v-if="data" :expect_min_award="data.expect_min_award" :expect_max_award="data.expect_max_award" ref="orderpop_" :is_open="radio" :amount="data.money" :shop_money="shop_money" :bei="data.bei" :check_game="data.check_game" :mode="2" :chuan_arr="data.chuan_arr" :game_type="data.type" @closeopendoor="closeopendoor()" :plan_desc="desc" >
