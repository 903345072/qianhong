	...
	<view class="zaiui-home-box" :class="show?'show':''">
		...
		<view class="main-bg" >
			...
			<view style="position: absolute;left:0;right:0;bottom: 0;  background-color: #80b7f9;height: 130rpx;margin:0 15rpx;border-radius: 20rpx 20rpx 0 0;display: flex;justify-content: space-around;align-items: center;">
				...
				<view @click="toConnect()" style="display: flex;flex-direction: column;align-items: center;">
					<view style="background-color: white; width: 60rpx;height: 60rpx;border-radius: 60rpx;display: flex;justify-content: center;align-items: center;">
						<img style="width: 30rpx;height: 30rpx;" src="/static/images/index/msg.jpeg" alt="">
					</view>
					<view style="color: white;padding-top:5rpx">在线联系</view>
				</view>
		...
		<view style="box-shadow: 5rpx 5rpx 10rpx #CCCCCC;color: white;padding: 25rpx 20rpx;margin: 10rpx 20rpx;margin-top: 30rpx;border-radius: 20rpx;">
			...
			<view style="display: grid;grid-template-columns: 1fr 1fr 1fr 1fr; margin-right: 20rpx;margin-top: 20rpx;">
				<view @tap="toFootball" v-if="games.includes(1)"  style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
				...
				<view @tap="toBasketball" v-if="games.includes(2)" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
				...
				<view @tap="toPl3()" v-if="games.includes(4)"  style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
				...
				<view @tap="toBeijing" v-if="games.includes(3)" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
				...
				<view v-if="games.includes(5)" @tap="torenjiu(0)"  style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
					<image src="/static/images/index/renjiu.png" style="width: 120rpx;height: 110rpx;"></image>
					<text style="color: #333333;margin-top: 5rpx;">胜负彩14场</text>
				</view>
				
				<view v-if="games.includes(5)" @tap="torenjiu(1)"  style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
					<image src="/static/images/index/logo-rxj.png" style="width: 120rpx;height: 110rpx;"></image>
					<text style="color: #333333;margin-top: 5rpx;">任选9场</text>
				</view>
			</view>
		...
		<view style="display: flex;align-items: center;margin: 40rpx 20rpx;justify-content: space-between;">
			<view>
				<text style="border-left: 4px solid red;height: 32rpx;"></text>
				<text style="padding-left: 10rpx;font-size: 32rpx;">昨日红单榜</text>
			</view>
			<view @click="getMore">
				<text>查看更多</text>
		...
		<view v-if="list.length>0" style="background: url('../../../static/images/index/rank_bg.png') no-repeat 50%;background-size: 100% 240px;height: 400rpx;padding: 20rpx;width: 100%;">
		   <view style="display: flex;align-items: center;justify-content: space-around;">
			   <view style="display: flex;flex-direction: column;align-items: center;justify-content: center;text-align: center;margin-top: 80rpx;margin-left: 20rpx;">
				   <view style="position: relative;width: 120rpx;height: 120rpx;margin: 0 20rpx;">
				   	<image :src='list[1]["user"]["avatar"]' style="position: absolute;width: 92rpx;height: 92rpx;border-radius: 100%;top: 18rpx;left:18rpx;border: 2px solid #d06543;"></image>
				   </view>
				   <text style="font-size: 32rpx;padding-bottom: 20rpx;">{{list[1]["user"]["real_name"]}}</text>
				   <text style="color: #d04343;font-weight: 700;font-size: 36rpx;padding-bottom: 4rpx;">{{list[1]["award_money"]}}</text>
				   <text style="font-size: 23rpx;">奖金</text>
			   </view>
			   
			   <view style="display: flex;flex-direction: column;align-items: center;justify-content: center;text-align: center;margin-top: -60rpx;">
			   				   <view style="position: relative;width: 120rpx;height: 120rpx;margin: 0 20rpx;">
			   				   	<image :src='list[0]["user"]["avatar"]' style="position: absolute;width: 92rpx;height: 92rpx;border-radius: 100%;top: 18rpx;left:18rpx;border: 2px solid #d0a143;"></image>
			   				   </view>
			   				   <text style="font-size: 32rpx;padding-bottom: 20rpx;">{{list[0]["user"]["real_name"]}}</text>
			   				   <text style="color: #d04343;font-weight: 700;font-size: 36rpx;padding-bottom: 4rpx;">{{list[0]["award_money"]}}</text>
							   <text style="font-size: 23rpx;">奖金</text>
			   </view>
			   
			   <view style="display: flex;flex-direction: column;align-items: center;justify-content: center;text-align: center;margin-top: 120rpx;margin-right: 25rpx;">
			   				   <view style="position: relative;width: 120rpx;height: 120rpx;margin: 0 20rpx;">
			   				   	<image :src='list[2]["user"]["avatar"]' style="position: absolute;width: 92rpx;height: 92rpx;border-radius: 100%;top: 18rpx;left:18rpx;border: 2px solid #979797;"></image>
			   				   </view>
			   				   <text style="font-size: 32rpx;padding-bottom: 20rpx;">{{list[2]["user"]["real_name"]}}</text>
			   				   <text style="color: #d04343;font-weight: 700;font-size: 36rpx;padding-bottom: 4rpx;">{{list[2]["award_money"]}}</text>
							   <text style="font-size: 23rpx;">奖金</text>
			   </view>
		   </view>
		</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				config:"",shopName:"",logo:"",phone:"",wechat:"",qrcode:"",mask: false,is_seller:false,"gonggao":"欢迎您的到来!",games:[],list:[]
			}
		},
		props: {
			show: {
		...
		mounted() {
			...
			this.$api.getShopInfo({}).then(res=>{
				...
				that.gonggao = res.data.gonggao
				that.games = res.data.shop_games
			})
			this.$api.getUserInfo().then(res=>{
				this.qrcode = res.data.data.qrcode
				this.is_seller = res.data.data.is_seller
			})
			this.$api.getAwardRank().then(res=>{
				this.list = res.data
		...
		methods: {
			...
			torenjiu(index){
				uni.navigateTo({
					url: "/pages/renjiu/index?index="+index
				});
			},
			toPl3() {
				uni.navigateTo({
