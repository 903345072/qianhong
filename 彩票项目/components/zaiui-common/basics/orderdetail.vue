		...
		<view style="display: flex;flex-direction: column;align-items: center;margin-top: -150rpx;z-index: 999999999;position: relative;">
			...
			<view
						...
						<view
										...
										<view @tap="previews(orderdetail.order_pic)">
											<image v-if="orderdetail.order_detail_.length >0" :src="orderdetail.order_pic"></image>
											<text style="text-align: center;" v-if="orderdetail.order_detail_.length == 0">开赛后可见</text>
										</view>
